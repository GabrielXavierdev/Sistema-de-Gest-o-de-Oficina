...
def init_db():
    ...
    try:
        ...
        # Clientes
        client1 = Client(name="Giudison Torres", address="Av Senador Robert Kennedy, 123", phone="(81)940028922", email="giudisontorres@gmail.com")
        client2 = Client(name="Andrew Matheus", address="Avenida Principal, 456", phone="(81)934313218", email="andrewmatheus@gmail.com")
        client3 = Client(name="Leandro Lima", address="Rua ilheus, 40", phone="(81)988066050", email="leandrolima@gmail.com")
        client4 = Client(name="Gabriel Henrique", address="Rua itabuna, 150", phone="(81)986909790", email="gabrielhenrique@gmail.com")
